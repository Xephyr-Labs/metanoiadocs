...
// ── toast ───────────────────────────────────────────────────────────────────
// One floating line, appended to the body. A menu closes on select, so there is
// no component left to render feedback into — and a copy that quietly failed is
// exactly the thing the user must be told about.
