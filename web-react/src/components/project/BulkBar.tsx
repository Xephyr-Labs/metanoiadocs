  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="pointer-events-auto fixed bottom-4 left-1/2 z-30 flex max-w-[calc(100vw-2rem)]
                   -translate-x-1/2 items-center gap-1 overflow-x-auto rounded-lg border border-line
                   bg-canvas px-2 py-1.5 shadow-pop"
      >
